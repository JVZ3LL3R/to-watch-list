...
CREATE TABLE CONTENT (
    ...
    CONT_OVERVIEW VARCHAR (1000) NOT NULL,
    CONT_COUNTRY VARCHAR (50) NOT NULL,
    CONT_DURATION VARCHAR (5) NOT NULL,
    CONT_POSTER VARCHAR (200) NOT NULL,
    CONT_TRAILER VARCHAR (200) NOT NULL,
    CONT_RATING VARCHAR (5) NOT NULL,
	CONT_DIR VARCHAR(50) NOT NULL,
	CONT_WATCHED BOOLEAN NOT NULL,
	CONT_DT_CAD TIMESTAMP NOT NULL,
